...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('voting_app', '0008_usersurveyjunctionmodel_is_voted'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='surveys', related_query_name='survey', to='voting_app.surveymodel'),
        ),
        migrations.AlterField(
            model_name='usersurveyjunctionmodel',
            name='user',
